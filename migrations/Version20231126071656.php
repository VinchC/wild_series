 ...
 */
final class Version20231126071656 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program ADD category_id INT NOT NULL, CHANGE synoposis synopsis LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program DROP category_id, CHANGE synopsis synoposis LONGTEXT NOT NULL');
    }
}
